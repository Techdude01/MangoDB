...
BEGIN
   ...
   INSERT INTO Response (userID, responseText, TimeStampID, status)
   VALUES (p_userID, p_responseText, @tsID, 'draft')
END;
//
DELIMITER;
...
-- RETRIEVE RESPONSES
DELIMITER // CREATE PROCEDURE RetrieveResponses(IN p_userID INT, IN p_questionID INT, OUT )
BEGIN 
